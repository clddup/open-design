export const layoutMessages = {
  ...
  "history.reorderSmartSelection": "Reorder Smart Selection",
  "history.moveGridContent": "Move Grid content",
  "history.resizeGridSpan": "Resize Grid span",
  ...
  "history.updateRulerGuides": "Update ruler guides",
  "canvas.rulersAndGuides": "Rulers and guides",
  "canvas.rulerGuideLabel": "{{axis}} guide at {{offset}}",
  "canvas.rulerGuideLocked": "Unlock the frame before editing its guides.",
  "canvas.removeGuide": "Remove guide",
  "canvas.rulerGuideStale":
  ...
  "properties.rotationOrigin": "Rotation origin",
  "properties.editRotationOrigin": "Edit rotation origin (Option/Alt+R)",
  "properties.resetRotationOrigin": "Reset rotation origin to center",
