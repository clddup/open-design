...
const VECTOR_ACTION_BRANCHES = [
  ...
  vectorBranch("split-vector", { nodeId: ID_SCHEMA }, ["nodeId"]),
  vectorBranch(
    "set-closed",
    {
      nodeId: ID_SCHEMA,
