...
- `Tooltip`, `TooltipProvider`, `DropdownMenu`, `DropdownMenuItem`, `DropdownMenuSeparator`, and the context-bound Message API wrap selected `@base-ui/react` primitives for keyboard navigation, Escape dismissal, focus restoration, collision handling, timed feedback, live-region announcements, stack limiting, and portal behavior.
