---
name: ui-visual-direction
description: Establish a distinctive, context-specific visual thesis before creating an OpenDesign UI target.
---
...
- a dominant color/material relationship with deliberate contrast;
- composition tension through asymmetry, overlap, scale contrast, cropping, or controlled density when appropriate;
...
- The design generation should establish a dominant field, an actionable core, and at least one crafted relationship between them; a small generic card floating in unused space is not enough.
...
The initial visible committed revision must already demonstrate the thesis and signature decision. Do not postpone all identity to a later refinement.
