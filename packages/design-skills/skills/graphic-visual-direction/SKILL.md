---
name: graphic-visual-direction
description: Choose a subject-specific composition and evidence medium for posters, brand assets, logos, illustrations, and presentation visuals.
---
...
Use `surfaceMode=graphic`; infer expressiveness and density from communication distance, format, content, identity posture, and audience. Make calibration visible through hierarchy, scale, negative space, type, crop, contour, and material—not captions.
...
- A compact design generation may establish the artboard, editable type, color field, and image aperture. It must then generate and place required imagery before review. If unavailable, preserve the scaffold and report the missing evidence instead of faking realism.
