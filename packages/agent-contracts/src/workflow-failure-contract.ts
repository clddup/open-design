...
export const DESIGN_WORKFLOW_FAILURE_DEFINITIONS = [
  ...
  definition("plan_revision_stale", "plan-repair", false),
  definition("plan_review_step_host_owned", "capture", false),
  definition("plan_review_step_invalid", "capture", false),
  definition("plan_step_evidence_missing", "material-write", false),
  definition("plan_step_order_invalid", "plan-repair", false),
  definition("plan_step_state_invalid", "plan-repair", false),
