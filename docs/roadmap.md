...
- 继续按垂直切片迁移专业基础文档版本；`DesignDocument 1.18.0` 已在轴向 Fixed/Hug/Fill、Horizontal Wrap、Min/Max 与 Auto gap 基础上增加 Ignore flow / Absolute child，后续仍需分支与多轮廓、Slice、grid、Text/Font rich typography、图片 adjustments、Variant/Component Properties、跨文件 Library、style/token binding 和 export settings。
