...
- [ ] 继续完成跨多个 Vector 图层拖拽 Cut、开放描边切割、compound hole redistribution、凹形多交点、连接/断开、分支网络、套索、多节点变换框、flatten、outline stroke 与正式 Slice；补真实像素 baseline 和 macOS/Windows 打包产品交互证据。
