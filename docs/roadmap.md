...
- 扩展 Text/Font service，支持字体二进制 asset/授权/内容寻址加载、完整 `FontName.style` 身份、富文本 runs、逐段样式、列表、OpenType/variable font axis、text-on-path 和确定性跨平台 shaping。macOS 与 Windows 必须产生明确兼容结果或 fidelity warning。
