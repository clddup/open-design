...
- 继续按垂直切片迁移专业基础文档版本；`DesignDocument 1.14.0` 已在 `1.13.0` 线性 Auto Layout 基础上增加 Frame Fixed/Hug 与直属子层 Fixed/Fill，后续仍需分支与多轮廓、Slice、wrap/grid、Text/Font rich typography、图片 adjustments、Variant/Component Properties、跨文件 Library、style/token binding 和 export settings。
