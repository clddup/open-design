...
- 继续按垂直切片迁移专业基础文档版本；`DesignDocument 1.19.0` 已在响应式布局基础上增加 Frame Layout Guide / Uniform Grid，后续仍需分支与多轮廓、Slice、Columns/Rows guide、Auto Layout Grid、Text/Font rich typography、图片 adjustments、Variant/Component Properties、跨文件 Library、style/token binding 和 export settings。
