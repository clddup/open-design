...
pnpm test           passed
├── package tests   55 files / 521 tests
└── desktop tests   74 files / 604 tests
pnpm build          passed
├── Renderer
├── Electron Main
├── Preload
