...
pnpm test           passed
├── package tests   83 files / 744 tests
└── desktop tests   91 files / 707 tests
pnpm build          passed
├── Renderer
├── Electron Main
├── Preload
