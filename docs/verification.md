...
pnpm test           passed
├── package tests   47 files / 420 tests
└── desktop tests   57 files / 488 tests
pnpm build          passed
├── Renderer
├── Electron Main
├── Preload
