...
pnpm test           passed
├── package tests   55 files / 527 tests
└── desktop tests   74 files / 606 tests
pnpm build          passed
├── Renderer
├── Electron Main
├── Preload
