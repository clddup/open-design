...
pnpm test           passed
├── package tests   39 files / 310 tests
└── desktop tests   48 files / 372 tests
pnpm build          passed
├── Renderer
├── Electron Main
├── Preload
