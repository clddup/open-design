...
pnpm test           passed
├── package tests   47 files / 434 tests
└── desktop tests   57 files / 501 tests
pnpm build          passed
├── Renderer
├── Electron Main
├── Preload
