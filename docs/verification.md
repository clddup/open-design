...
pnpm test           passed
├── package tests   33 files / 230 tests
└── desktop tests   44 files / 326 tests
pnpm build          passed
├── Renderer
├── Electron Main
├── Preload
