...
pnpm test           passed
├── package tests   33 files / 224 tests
└── desktop tests   42 files / 306 tests
pnpm build          passed
├── Renderer
├── Electron Main
├── Preload
