...
pnpm test           passed
├── package tests   59 files / 576 tests
└── desktop tests   78 files / 638 tests
pnpm build          passed
├── Renderer
├── Electron Main
├── Preload
