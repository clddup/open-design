...
pnpm test           passed
├── package tests   44 files / 360 tests
└── desktop tests   57 files / 474 tests
pnpm build          passed
├── Renderer
├── Electron Main
├── Preload
