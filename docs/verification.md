...
pnpm test           passed
├── package tests   55 files / 501 tests
└── desktop tests   71 files / 585 tests
pnpm build          passed
├── Renderer
├── Electron Main
├── Preload
