...
└── desktop tests   40 files / 290 tests
pnpm build          passed
├── Renderer
├── Electron Main
├── Preload
...
6. 在应用内完成 SVG 选择导入、事务预览/撤销、选区/Frame 导出、fidelity report 和失败恢复；验证 `OD-BRAND-01` 导出/re-import 的真实 Leafer 外观。
