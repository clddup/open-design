...
pnpm test           passed
├── package tests   41 files / 332 tests
└── desktop tests   49 files / 428 tests
pnpm build          passed
├── Renderer
├── Electron Main
├── Preload
