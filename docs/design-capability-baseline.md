...
| 外观与合成        | 多 fill/stroke、纯色、线性/径向/角度渐变、图片填充、透明度、blend、描边位置/cap/join/dash、圆角、阴影、内阴影、光晕、模糊、灰度、蒙版、clip                | `DesignDocument 1.4.0`、EditorRuntime、属性面板和 Leafer 映射已实现主要语义；SVG v1 已可确定性往返最多八个普通零 spread 投影、一层 layer blur、效果顺序与可见性，并明确报告其余 filter 语义；复杂组合的视觉与完整导出保真仍待实机/基线验证                                                                                                                                                          |
...
| 导入              | OpenDesign native、SVG、PNG/JPEG/WebP/GIF、PDF、剪贴板矢量/位图；后续按明确需求评估 Figma/Sketch                                                           | native 文档、图片附件链与 SVG 产品路径部分实现；安全、版本化 SVG service、可取消 worker、EditorRuntime planner、Main 无路径文件桥、人工入口和 Agent run-scoped handle 已贯通。结构子集包含 Group/基础 shape/Path/Vector、transform、渐变、居中描边、基础 drop shadow/layer blur，并返回显式 fidelity report；其他设计格式和剩余 SVG 语义仍待实现                                                    |
| 导出与交付        | PNG/JPEG/WebP/SVG/PDF、多倍图、选区/Frame/批量导出、透明背景、颜色配置、token、开发检查、资源切图                                                          | SVG service、EditorRuntime planner、人工原生保存入口与 Agent typed export 已贯通显式 roots/Frame、revision、world transform、0-origin viewport、paint order、padding、ID、Boolean snapshot 和基础 filter effects。PNG/JPEG/WebP/PDF、outline text/stroke、持久 export settings、复杂 filter/mask/image/text fidelity、双平台实机与完整专业交付仍待实现；画布截图不算交付产物                        |
